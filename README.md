...
git clone https://github.com/zarishsphere/zs-svc-diagnostic.git
cd zs-svc-diagnostic
...
See [docs.zarishsphere.com/api/zs-svc-diagnostic](https://docs.zarishsphere.com/api/zs-svc-diagnostic) for the full OpenAPI 3.1 specification.
